...
const BgAnimate = () => {
  return <svg version="1.1" width="900" height="900" viewBox="0 0 320 320" fill="none" stroke="#000" strokeLinecap="round"
    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"> <defs>
      <path id="r1">
