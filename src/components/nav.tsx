            ...
            <ul>
                <li className="start">
                    <div className='div-logo'>
                        <a className="btn" href="https://vitejs.dev">
                ...
                <div className="menue-no-modal">
                    ...
                    <li className="end">
                        <a href="https://www.NavLinkedin.com/in/juan-jos%C3%A9-eusebi-rodriguez-a6aaa8278/">
                            <svg className="fill-icon" fill="#000000" viewBox="-5.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                <title>NavLinkedin</title>
